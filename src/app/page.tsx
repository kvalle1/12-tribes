...
export default async function Home() {
  // Surface a "View your results" entry only to a signed-in Subject who has a
  // saved result (issue #18). Signed-out visitors and signed-in users who
  // haven't taken the assessment never see it. Reading the session here makes
  // the home page dynamic, which is fine — it stays a lightweight server render.
