 ...
 *
 * The full reading — headline, the 12-tribe ranking bars, the words chosen, and
 * the profile links — lives in the shared `ResultView` so it renders identically
 * here (post-submit) and on the profile page (#18).
 */
