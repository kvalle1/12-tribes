 ...
 * word-selections. Ordering by `createdAt` keeps the anonymous "Observer 1/2/3"
 * labels stable across renders without exposing any observer identity. Feeds
 * `aggregateObservers` (issue #9); nothing here reveals who an Observer is.
 */
