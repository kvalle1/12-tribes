 ...
 * the input to the equal-weight aggregation (issue #9). Ordering by `createdAt`
 * keeps the anonymous "Observer 1/2/3" drill-down labels stable across renders.
 * Returns only the selected words: no observer id, timestamp, or any other
 * identifying attribute crosses this boundary, preserving anonymity (ADR-0003).
 */
