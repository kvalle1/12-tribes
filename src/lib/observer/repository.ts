 ...
 * bare word selections — the input the equal-weight `aggregateObservers`
 * aggregation consumes (issue #9). Ordering by `createdAt` keeps the anonymous
 * "Observer 1 / 2 / 3" numbering stable across page loads. Only the words are
 * returned; nothing here carries or exposes Observer identity (ADR-0003).
 */
