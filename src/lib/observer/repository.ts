 ...
 * bare selected words — nothing that could identify who answered (ADR-0003).
 * The stable `createdAt` ordering gives the comparison report a consistent
 * "Observer 1 / 2 / 3 …" numbering across page loads without attaching any
 * attribute to a response. Feeds the equal-weight aggregation (issue #9).
 */
